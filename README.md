...
### Các thông báo phát sinh
  ...
  - **Không thể thoát thuật toán khi đang chạy**: ![image](./image/cannot_exit.png)
  - **Hoàn thành thuật toán**: ![image](./image/complete.png)
  - **Không tìm thấy đường đi**: ![image](./image/not_found.png)
  - **Xác nhận thoát app**: ![image](./image/confirm_exit.png)
